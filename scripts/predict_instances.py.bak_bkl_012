...
def schedule_instance(cursor, p, day):
    # Prevent regeneration if a real txn already exists near this date
...
def predict_fixed_transactions(cursor, today, end_date):
    ...
    for p in predictions:
        ...
        # ✅ FIX #1: weekly / fortnightly should be forward-only rolling sequences
        # This prevents “missed” past instances being recreated.
        ...
        # ✅ FIX #2: monthly patterns honour repeat_interval (every N months)
